...
requirejs.config({
	...
	shim: {
		...
		// Other
		'ff/dialog': {deps: ['css!lib/artdialog/css/ui-dialog.css'],exports:'dialog'},
		'frontEngineDialog': {deps: ['ff/dialog']},
		'ff/select2': {deps: ['css!lib/select2/css/select2.css']},
		'ff/validate': {deps: ['css!lib/validation/css/validation.css']}
	},
	enforceDefine: true,
